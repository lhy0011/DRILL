...
class IdleState:
    ...
    def do(boy):
        ...
        boy.frame = (boy.frame + FRAMES_PER_ACTION * ACTION_PER_TIME * game_framework.frame_time) % 8
        if boy.bin:
            boy.x += boy.bspeed * game_framework.frame_time
...
class RunState:
    ...
    def do(boy):
        ...
        if boy.bin:
            boy.y = boy.by + 60
            if boy.x > boy.bx -90 or boy.x < boy.bx + 90:
                boy.x += boy.velocity * game_framework.frame_time
                # boy.x = clamp(boy.bx - 90, boy.x, boy.bx + 90)
...
class Boy:
    ...
    def inbrick(self, bx, by, bspeed):
        self.bin = True
        self.bx = bx
        self.by = by
        self.bspeed = bspeed

    def bupdate(self, bx, bspeed):
        self.bx = bx
        self.bspeed = bspeed
